$(document).ready(function(){
  ...
  for (var i = 0; i < 96; i++) {
	...
	$("#st14").attr("id", "WA").addClass("truestate").append("<div class='statename'>MA</div>");
	$("#st16").attr("id", "MT").addClass("truestate").append("<div class='statename'>MT</div>");
	$("#st17").attr("id", "ND").addClass("truestate").append("<div class='statename'>MD</div>");
	$("#st20").attr("id", "MI").addClass("truestate").append("<div class='statename'>MI</div>");
	$("#st22").attr("id", "VT").addClass("truestate").append("<div class='statename'>VY</div>");
	...
	$("#st30").attr("id", "WI").addClass("truestate").append("<div class='statename'>WI</div>");
	$("#st31").attr("id", "MN").addClass("truestate").append("<div class='statename'>MN</div>");
	...
	$("#st42").attr("id", "IL").addClass("truestate").append("<div class='statename'>IL</div>");
	...
	$("#st45").attr("id", "PA").addClass("truestate").append("<div class='statename'>PA</div>");
	...
	$("#st54").attr("id", "IA").addClass("truestate").append("<div class='statename'>IA</div>");
	$("#st55").attr("id", "MO").addClass("truestate").append("<div class='statename'>MO</div>");
	$("#st56").attr("id", "KY").addClass("truestate").append("<div class='statename'>KY</div>");
	$("#st57").attr("id", "NJ").addClass("truestate").append("<div class='statename'>NJ</div>");
	$("#st58").attr("id", "DC").addClass("truestate").append("<div class='statename'>DC</div>");
	$("#st59").attr("id", "DE").addClass("truestate").append("<div class='statename'>DE</div>");
	...
	$("#st66").attr("id", "AR").addClass("truestate").append("<div class='statename'>AR</div>");
	$("#st67").attr("id", "TN").addClass("truestate").append("<div class='statename'>TN</div>");
	$("#st68").attr("id", "AL").addClass("truestate").append("<div class='statename'>AL</div>");
	$("#st69").attr("id", "MD").addClass("truestate").append("<div class='statename'>MD</div>");
	$("#st70").attr("id", "VA").addClass("truestate").append("<div class='statename'>VA</div>");
	$("#st71").attr("id", "NC").addClass("truestate").append("<div class='statename'>NC</div>");
	$("#st77").attr("id", "TX").addClass("truestate").append("<div class='statename'>TX</div>");
	$("#st78").attr("id", "LA").addClass("truestate").append("<div class='statename'>LA</div>");
	$("#st79").attr("id", "MS").addClass("truestate").append("<div class='statename'>MS</div>");
	$("#st81").attr("id", "GA").addClass("truestate").append("<div class='statename'>GA</div>");
	$("#st82").attr("id", "SC").addClass("truestate").append("<div class='statename'>SC</div>");
	$("#st94").attr("id", "FL").addClass("truestate").append("<div class='statename'>FL</div>");
